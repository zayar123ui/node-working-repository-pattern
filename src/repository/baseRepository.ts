...
>(
  ...
  abstract class AbstractBaseRepository {
    ...
    >(
      ...
      return {
        // @ts-ignore
        rows: (await models[AbstractBaseRepository.modelName].findMany({
          // @ts-ignore
          where,
          ...option,
          skip: offset,
    ...
    >(conditions: Where | number | string, option: Option = {} as Option) {
      ...
      // @ts-ignore
      return models[AbstractBaseRepository.modelName].findFirst({
        // @ts-ignore
        where,
        ...option,
    ...
    >(conditions: Cursor | number | string, option: Option = {} as Option) {
      ...
      // @ts-ignore
      return models[AbstractBaseRepository.modelName].findUnique({
        // @ts-ignore
        where,
        ...option,
      }) as Promise<Return | null>;
    ...
    >(data: Create, option: Option = {} as Option) {
      // @ts-ignore
      return models[AbstractBaseRepository.modelName].create({
        data,
        ...option,
      }) as Promise<Return | null>;
    }
    ...
    >(conditions: Where | number | string, data: Payload, option: Option = {} as Option) {
      ...
      // @ts-ignore
      return models[AbstractBaseRepository.modelName].update({
        data,
        // @ts-ignore
        where,
        ...option,
    ...
    public static async delete(conditions: Where | number | string) {
      ...
      // @ts-ignore
      return models[AbstractBaseRepository.modelName].deleteMany({
        // @ts-ignore
        where,
    ...
    >(conditions: Where | number | string, options: Option = {} as Option) {
      ...
      // @ts-ignore
      return models[AbstractBaseRepository.modelName].delete({
        // @ts-ignore
        where,
        ...options,
      }) as Promise<Return>;
    ...
    public static async bulkCreate(data: Prisma.Enumerable<Create>, skipDuplicates = true) {
      // @ts-ignore
      return models[AbstractBaseRepository.modelName].createMany({
        data,
        // @ts-ignore
        skipDuplicates,
      }) as Promise<Prisma.BatchPayload>;
    ...
    public static async bulkUpdate(where: Where, data: Prisma.Enumerable<Update>) {
      // @ts-ignore
      return models[AbstractBaseRepository.modelName].updateMany({
        data,
        where,
      }) as Promise<Prisma.BatchPayload>;
    }
    ...
    public static async count(
      ...
      // @ts-ignore
      return models[AbstractBaseRepository.modelName].count({
        // @ts-ignore
        where,
        ...option,
      }) as Promise<number>;
    ...
    public static async groupBy(
      ...
      // @ts-ignore
      return models[AbstractBaseRepository.modelName].groupBy({
        // @ts-ignore
        where,
        ...aggregator,
      });
    ...
    public static aggregate(
      ...
      // @ts-ignore
      const aggregate = models[AbstractBaseRepository.modelName].aggregate as Delegate['aggregate'];
      const where = extractCondition(conditions);
